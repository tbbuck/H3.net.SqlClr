...
public class LatLng {
    ...
    /// <summary>
    /// Creates a LatLng from an SqlGeography
    /// </summary>
    /// <param name="p"></param>
    /// <returns></returns>
    public static LatLng FromPoint( SqlGeography p) => new() {
        Latitude = p.Lat.Value * M_PI_180,
        Longitude = p.Long.Value * M_PI_180
    };
    ...
    /// <summary>
    /// Return the SqlGeography <see cref="Point"/> representation of this coordinate.
    /// </summary>
    /// <param name="geometryFactory"></param>
    /// <returns></returns>
    public SqlGeography ToPoint() {
        return SqlGeography.Point(LatitudeDegrees, LongitudeDegrees, 4326);
    }

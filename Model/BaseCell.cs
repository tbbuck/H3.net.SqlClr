...
public sealed class BaseCell {
    ...
    /// </summary>
    public sbyte Cell { get; internal set; }

    /// <summary>
    /// The home face and IJK address of the cell.
    /// </summary>
    public FaceIJK Home { get; internal set; } = null!;

    /// <summary>
    /// Whether or not this base cell is a pentagon.
    /// </summary>
    public bool IsPentagon { get; internal set; }

    /// <summary>
    /// If a pentagon, the cell's two clockwise offset faces.
    /// </summary>
    internal sbyte[] ClockwiseOffsetPent { get; set; } = null!;

    /// <summary>
    /// Whether or not the cell is a polar pentagon.
    /// </summary>
    public bool IsPolarPentagon { get; internal set; }

    /// <summary>
    /// All of the neighbouring <see cref="BaseCell"/>s of this cell, by
    /// <see cref="Direction"/>.
    /// </summary>
    public sbyte[] NeighbouringCells { get; internal set; } = null!;
    ...
    /// </summary>
    public sbyte[] NeighbourRotations { get; internal set; } = null!;

    /// <summary>
    /// A map of neighbour cell number to <see cref="Direction"/>.
    /// </summary>
    public Dictionary<sbyte, Direction> NeighbourDirections { get; internal set; } = null!;
